...
public class Signature extends XMLFileManagement implements SignatureInterface {
	 ...
	 */
	@Override
	public Document enclosingMethod(String YANGdata, String signature) {
		...
		try {
			document = loadXMLDocument(YANGdata);
	...
	@Override
	public Document enclosingMethod2(String notificationYANG, String signature) {

		Parameters param = new Parameters();
		Document document = null;

		try {
			document = loadXMLDocument(notificationYANG);
			...
			System.out.println(rootElement.indexOf(notificationElement) + 1);
...
//	public Document enclosingMethod3(String metadataYANG, String signature) {
//
//		Parameters param = new Parameters();
//		Document document = null;
//
...
//			provenanceElement.setText(signature);
//
//			rootElement.addContent(0, provenanceElement);
//
//		} catch (JDOMException | IOException e) {
//			e.printStackTrace();
//		}
